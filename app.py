...
def gauge(value: float, titulo: str = "ROI") -> str:
    ...
    return f'''<div class="gauge"><svg viewBox="0 0 260 160"><path d="M35 130 A95 95 0 0 1 225 130" fill="none" stroke="#1d2a3b" stroke-width="22"/><path d="M35 130 A95 95 0 0 1 100 42" fill="none" stroke="#f04b3d" stroke-width="18"/><path d="M100 42 A95 95 0 0 1 170 42" fill="none" stroke="#f2df34" stroke-width="18"/><path d="M170 42 A95 95 0 0 1 225 130" fill="none" stroke="#23b64a" stroke-width="18"/><line x1="130" y1="130" x2="130" y2="55" stroke="#ffffff" stroke-width="6" transform="rotate({angle:.1f} 130 130)"/><circle cx="130" cy="130" r="8" fill="#ffffff"/><text x="40" y="128" fill="#e7f0ff" text-anchor="middle" font-size="12">0%</text><text x="95" y="48" fill="#e7f0ff" text-anchor="middle" font-size="12">1,5%</text><text x="172" y="48" fill="#e7f0ff" text-anchor="middle" font-size="12">3%</text><text x="220" y="128" fill="#e7f0ff" text-anchor="middle" font-size="12">5%</text></svg><div class="gauge-num">{pct(value)}</div><div class="badge {cls}">{badge}</div><small>{titulo} • Meta: 5,00%</small></div>'''
